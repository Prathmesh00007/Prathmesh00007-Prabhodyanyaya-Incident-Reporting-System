...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const statsResponse = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/admin/dashboard-stats', {
        credentials: 'include'
      });
      ...
      const registrationsResponse = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/admin/view-registrations', {
        credentials: 'include'
      });
      ...
      // Fetch all users
      const usersResponse = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/admin/all-users', {
        credentials: 'include'
      });
  ...
  const handleUserApproval = async (userId, approved) => {
    try {
      const response = await fetch(`https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/admin/verify/${userId}`, {
        method: 'POST',
        headers: {
  ...
  const handleUserRemoval = async (userId) => {
    if (window.confirm('Are you sure you want to remove this user?')) {
      try {
        const response = await fetch(`https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/admin/remove-user/${userId}`, {
          method: 'DELETE',
          credentials: 'include'
        });
