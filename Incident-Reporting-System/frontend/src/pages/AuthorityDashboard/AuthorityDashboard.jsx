...
const AuthorityDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const statsResponse = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/authority/dashboard', {
        credentials: 'include'
      });
      ...
      const assignedResponse = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/authority/assigned-incidents', {
        credentials: 'include'
      });
      ...
      // Fetch all incidents
      const allIncidentsResponse = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/authority/view-incidents', {
        credentials: 'include'
      });
      ...
      // Fetch feedback data
      const feedbackResponse = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/authority/feedback', {
        credentials: 'include'
      });
  ...
  const handleUpdateIncident = async (incidentId) => {
    ...
    try {
      const response = await fetch(`https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/authority/update-incident/${incidentId}`, {
        method: 'PUT',
        headers: {
  ...
  const handleStatusUpdate = async (incidentId) => {
    ...
    try {
      const response = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/authority/update-status', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleMarkAsResolved = async (incidentId) => {
    if (window.confirm('Are you sure you want to mark this incident as resolved?')) {
      try {
        const response = await fetch(`https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/authority/mark-solved/${incidentId}`, {
          method: 'PUT',
          credentials: 'include'
        });
        ...
        if (data.success) {
          fetchDashboardData();
          alert('Incident forwarded to Cyber Cell!');
        }
      } catch (error) {
