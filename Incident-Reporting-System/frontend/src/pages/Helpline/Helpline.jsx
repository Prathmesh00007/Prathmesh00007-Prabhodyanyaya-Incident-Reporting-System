...
import { Phone, MessageCircle, Send, AlertTriangle, Shield, Users, Clock, ExternalLink, FileText } from 'lucide-react';
...
const Helpline = () => {
  ...
  const fetchHelplineStats = async () => {
    try {
      const response = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/helpline/stats');
  ...
  const fetchTemplates = async () => {
    try {
      const response = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/helpline/templates');
      const data = await response.json();
      if (data.success) {
  ...
  const handleVerifyScam = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/helpline/verify-scam', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                  ...
                  <div className="font-mono text-blue-900">
                    {stats?.helplineNumbers?.sms || '+91-9999-888877'}
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  ...
                  <div className="font-mono text-green-900">
                    {stats?.helplineNumbers?.whatsapp || '+91-9999-888877'}
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="font-mono text-gray-900">
                    {stats?.helplineNumbers?.phone || '+91-9999-888877'}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between items-center p-2 bg-white rounded">
                  <div className="flex items-center">
                    ...
                    <span className="text-red-700">Cyber Crime (1930)</span>
                  </div>
                  <div className="flex items-center space-x-2">
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-blue-900 mb-4">🛡️ National Cybercrime Reporting Portal</h3>
              
              <div className="space-y-3">
                <div className="p-3 bg-white rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-blue-900">File Online Complaint</h4>
                    <button
                ...
                <div className="p-3 bg-white rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-blue-900">Financial Fraud (1930)</h4>
                    <button
                      onClick={() => window.open('tel:1930')}
                      className="text-blue-600 hover:text-blue-800"
                    >
                  ...
                  <p className="text-sm text-blue-700">
                    Call immediately for fund freeze attempts
                  </p>
                </div>
                
                <div className="p-3 bg-white rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-blue-900">WhatsApp Helpline</h4>
                    <button
                      onClick={() => window.open('https://wa.me/919315717007', '_blank')}
                      className="text-blue-600 hover:text-blue-800"
                    >
            ...
            <div className="bg-green-50 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-green-900 mb-4">⚖️ Legal Action Guide</h3>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-green-900">Immediate Action</h4>
                    <p className="text-green-700">Call 1930 for financial fraud or file NCRP complaint</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-green-900">File FIR</h4>
                    <p className="text-green-700">Visit nearest police station with evidence packet</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-green-900">Follow-up</h4>
                    <p className="text-green-700">Regular follow-up on case status</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <div className="w-6 h-6 bg-green-600 text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">4</div>
                  <div>
                    <h4 className="font-medium text-green-900">Escalation</h4>
                    <p className="text-green-700">Escalate to higher authorities if no progress</p>
                  </div>
                </div>
              </div>
            </div>
