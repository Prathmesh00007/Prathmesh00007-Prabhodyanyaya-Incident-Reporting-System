...
GET https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/auth/debug/users
```
...
```bash
# Test login
curl -X POST https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"test@example.com","password":"password"}'

# Test debug endpoint
curl https://prathmesh00007-prabhodyanyaya-incident.onrender.com/api/auth/debug/users
```
